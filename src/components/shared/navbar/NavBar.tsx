    ...
    <header className="sticky top-0 z-50 w-full border-b border-[#E2E8F0] bg-[#F8FAFC]/95 backdrop-blur-sm">
      ...
      >
        ...
        <Button
          ...
          className="text-[#0F172A] outline-none focus-visible:ring-2 focus-visible:ring-[#7C3AED] focus-visible:ring-offset-2 md:hidden"
        >
          {isMenuOpen ? (
      ...
      <div
        ...
        inert={!isMenuOpen}
        className={`overflow-hidden border-t border-[#E2E8F0] bg-[#F8FAFC] transition-[max-height,opacity] duration-300 ease-in-out md:hidden ${
